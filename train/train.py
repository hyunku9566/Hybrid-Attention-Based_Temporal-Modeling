"""
Train Baseline ADL Recognition Model

Main training script for the baseline TCN + BiGRU + Attention model.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train Baseline ADL Recognition Model')
...
def main():
    ...
    print("=" * 80)
    print("🚀 Training Baseline ADL Recognition Model")
    print("=" * 80)
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > best_val_acc:
            ...
            patience_counter = 0
            save_path = os.path.join(args.checkpoint_dir, 'best_baseline.pt')
